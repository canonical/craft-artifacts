...
- The most recent patch version of Craft Artifacts.
- Any version of Craft Artifacts that's included in a current release of a Canonical
  product.
...
[Private Security Report]: https://github.com/canonical/craft-artifacts/security/advisories/new
